...
![](Documentation/imgs/svm/linear_equation.png) (1)
...
![](Documentation/imgs/svm/maximin.png)
...
![](Documentation/imgs/svm/linear_svm_graph.png)
...
![](Documentation/imgs/svm/svc.png)
...
![](Documentation/imgs/svm/svm.png)
...
![](Documentation/imgs/svm/poly_kernel.png)

and the radial kernel:

![](Documentation/imgs/svm/radial_kernel.png)

They result in a polynomially transformed (left, of degree 3) or radial (right) boundary, respectively:

![](Documentation/imgs/svm/poly_radial_graph.png)
...
![](Documentation/imgs/Accuracy-vs-Explainability.jpg)
